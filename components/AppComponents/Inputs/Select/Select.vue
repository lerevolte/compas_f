        ...
        <div class="select" ref="selectRef" :class="{ 'select_open': select.state.isOpen, 'select_icon': props.options.have_icon }">
            ...
            <div class="select__options">
                ...
                <div 
                    ...
                    :class="{ 'select__option_active': props.modelValue && (props.modelValue.value == option.value || (Array.isArray(props.modelValue) && props.modelValue.includes(option.value)))}" 
                    :value="option.value" 
